 ...
 * </br>
 */
public class SaleProgressBar extends View implements Runnable{
    ...
    public SaleProgressBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SaleProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        try {
            ...
            progress = (float) ta.getFloat(R.styleable.FlikerProgressBar_progress, 0);
            isFinish = (boolean) ta.getBoolean(R.styleable.FlikerProgressBar_isFinish, true);
            isStop = (boolean) ta.getBoolean(R.styleable.FlikerProgressBar_isStop, true);
        } finally {
            ta.recycle();
        }
    }
